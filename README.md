...
Всі методи мають обробку помилок через try-catch
...
2. Widget тести:
- перевірка наявності UI елементів
- перевірка роботи кнопки та відображення результату

## Обробка помилок
- API помилки обробляються через ApiException
- У випадку відсутності інтернету додаток не падає
- Виводяться повідомлення у консоль
